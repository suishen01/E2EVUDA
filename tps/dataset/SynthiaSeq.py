...
class SynthiaSeqDataSet(BaseDataset):
    def __init__(self, root, list_path, set='all',
        ...
        #if mvss_id:
        self.id_to_trainid = {8: 0, 11: 1, 10: 2, 7: 3, 15: 4, 9: 5, 1: 6, 3: 7, 4: 8, 6: 9, 2: 10,}
    ...
    def __getitem__(self, index):
        ...
        return image.copy(), label_copy.copy(), image_kf.copy(), label_kf_copy.copy(), image_kf.copy(), label_kf_copy.copy(), np.array(image.shape), name, raw_image_cf.transpose((2, 0, 1)), raw_image_kf.transpose((2, 0, 1)), raw_image_kf.transpose((2, 0, 1))
