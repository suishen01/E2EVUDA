...
from tps.dataset.CityscapesSeq_src import CityscapesSeq_src_DataSet
from tps.dataset.MVSS import MVSSDataSet
...
def main():
    ...
    if cfg.TRAIN.MODEL == 'ACCEL_DeepLabv2':
        ...
        img_model = get_accel_deeplab_v2(num_classes=cfg.NUM_CLASSES, multi_level=cfg.TRAIN.MULTI_LEVEL)
        ...
        if 'DeepLab_resnet_pretrained_imagenet' in cfg.TRAIN.RESTORE_FROM:
            ...
            img_model.load_state_dict(new_params)
        else:
    ...
    if cfg.SOURCE == 'Viper':
        ...
        source_dataset = SynthiaSeqDataSet(root=cfg.DATA_DIRECTORY_SOURCE,
                                     ...
                                     mean=cfg.TRAIN.IMG_MEAN)
    elif cfg.SOURCE == 'CityscapesSeq':
        source_dataset = CityscapesSeq_src_DataSet(root=cfg.DATA_DIRECTORY_SOURCE,
                                     list_path=cfg.DATA_LIST_SOURCE,
                                     set=cfg.TRAIN.SET_SOURCE,
                                     max_iters=cfg.TRAIN.MAX_ITERS * cfg.TRAIN.BATCH_SIZE_SOURCE,
                                     crop_size=cfg.TRAIN.INPUT_SIZE_SOURCE,
    ...
    if cfg.TARGET == 'CityscapesSeq':
        ...
        target_dataset = MVSSDataSet(root=cfg.DATA_DIRECTORY_TARGET,
                                           list_path=cfg.DATA_LIST_TARGET,
                                           set=cfg.TRAIN.SET_TARGET,
                                           info_path=cfg.TRAIN.INFO_TARGET,
                                           max_iters=cfg.TRAIN.MAX_ITERS * cfg.TRAIN.BATCH_SIZE_TARGET,
    ...
    # UDA TRAINING
    train_domain_adaptation(model, img_model, source_loader, target_loader, cfg)
