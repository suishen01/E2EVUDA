...
cfg.TRAIN.INFO_SOURCE = str(project_root / 'tps/dataset/CityscapesSeq_list/info_CityscapesSeq.json')
...
cfg.TRAIN.flow_path_src = '../../../TPSold/data/estimated_optical_flow_viper_train'
cfg.TRAIN.flow_path = '../../../TPSold/data/estimated_optical_flow_cityscapes_seq_train'
...
cfg.TEST.INTERVAL = 1
cfg.TEST.flow_path = '../../../TPSold/data/estimated_optical_flow_cityscapes_seq_val'
